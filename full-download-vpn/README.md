...
| [Readarr](https://docs.linuxserver.io/images/docker-readarr) | Readarris a Library Manager, automating the management and meta data for your eBooks and Comic media files |  
